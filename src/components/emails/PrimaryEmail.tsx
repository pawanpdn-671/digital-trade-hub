import { Body, Head, Hr, Html, Img, Preview, Section, Text, Container, Button, render } from "@react-email/components";
...
export const PrimaryEmailHtml = (props: EmailTemplateProps) =>
