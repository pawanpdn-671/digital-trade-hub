...
var syncUser = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var fullUser, products, Ids_1, createdProductIds, dataUpdate;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    Ids_1 = __spreadArray([], ((products === null || products === void 0 ? void 0 : products.map(function (product) { return (typeof product === "object" ? product.id : product); })) || []), true);
                    createdProductIds = Ids_1.filter(function (id, index) { return Ids_1.indexOf(id) === index; });
